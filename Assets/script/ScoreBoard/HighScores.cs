...
{
    const string privateCode = "Zz_3hldnwkuHC8wA1ZhODQsEONIC9tfkWeLgU2GeB7bQ";  //Key to Upload New Info
    const string publicCode = "64773a3a8f40bb7d84fa3f68";   //Key to download
